...
TOP_LEVEL_NAME="cic"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/eric/altera/15.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/cic_cic_ii_0.vo" -work cic_ii_0 -cdslib ./cds_libs/cic_ii_0.cds.lib
  ncvlog "$QSYS_SIMDIR/cic.v"                                                                        
fi
